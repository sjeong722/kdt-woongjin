...
# Configuration
SEOUL_API_KEY = "697246735167776f3130314a42654f63"  # 실제 운영 시 Variable이나 Connection으로 관리 권장
TARGET_LINES = [
    "1호선", "2호선", "3호선", "4호선", "5호선", 
    "6호선", "7호선", "8호선", "9호선",
...
default_args = dict(
    owner = 'kate29397',
    email = ['kate29397@gmail.com'],
    email_on_failure = False,
    retries = 1
)

with DAG(
    dag_id="kate29397_seoul_subway_monitor",
    ...
    def collect_and_insert_subway_data():
        hook = PostgresHook(postgres_conn_id='kate29397_supabase_conn')
