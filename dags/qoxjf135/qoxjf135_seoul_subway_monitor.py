...
# Configuration
SEOUL_API_KEY = "716a654d46716f7835365268626a78"  # 실제 운영 시 Variable이나 Connection으로 관리 권장
TARGET_LINES = [
    "1호선", "2호선", "3호선", "4호선", "5호선", 
    "6호선", "7호선", "8호선", "9호선",
...
with DAG(
    dag_id="qoxjf135_seoul_subway_monitor",
    ...
    slack_conn_id='qoxjf135_slack_conn',
    channel='#bot-playground',  # 보낼 채널명을 입력하세요 (예: #general)
    text=':rocket: 안녕하세요. 요청하신 서울 지하철 실시간 위치 추출 DAG가 성공적으로 실행되었습니다',
    username='봇이지뭐',
    )
